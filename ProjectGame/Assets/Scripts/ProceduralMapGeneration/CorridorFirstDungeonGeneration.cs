...
public class CorridorFirstDungeonGeneration : SimpleRandomWalkDungeonGenerator
{
    ...
    private HashSet<Vector2Int> CreateRooms(HashSet<Vector2Int> potentialRoomPositions)
    {
        ...
        List<Vector2Int> roomsToCreate = potentialRoomPositions.OrderBy(x => Guid.NewGuid()).Take(roomToCreateCount).ToList(); //Ved ikke hvad fuck Guid og den her linje betyder
